...
## 2026-05-19 correction — restored canonical history stubs

Canonical history stubs restored in `machine/issue/sprint_9/` for done issues `024`, `032`, and `033`. Older `work/024`, `work/032`, and `backlog/033` path mentions are historical only and must not be treated as current active/backlog files.
