...
public class SvgExporter {
    public String export(Diagram diagram) {
        ...
        svg.append("<style>text{font:14px sans-serif}.card{fill:#151922;stroke:#6aa5ff;stroke-width:1.5}.head{fill:#1f2a3d}.line{stroke:#8fa3bf;stroke-width:1.5;fill:none}.lifeline{stroke-dasharray:8 6}.activation{fill:#263752;stroke:#60a5fa;stroke-width:1}.pk{fill:#ffd166}</style>\n");
    ...
    private void exportSequence(Diagram diagram, StringBuilder svg) {
        for (SequenceParticipant p : diagram.getParticipants()) {
            ...
            svg.append(text(r.x() + 12, r.y() + 30, p.getName()));
        ...
        for (SequenceMessage m : diagram.getMessages()) {
            ...
            svg.append("<path class=\"line\" marker-end=\"url(#arrow)\" d=\"M ")
                    ...
                    .append("\"/>\n");
            svg.append(text(Math.min(from.center().x(), to.center().x()) + 12, y - 8, m.getLabel()));
            if (m.isActivation()) {
